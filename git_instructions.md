...
## Последовательность работы с ветками
...
*пример* или _пример_
    ...
    ***<жирный курсив>*** или ___<жирный курсив>___

**пример*** или ___пример___

    ~~зачеркнутый~~
~~пример~~

    Tab или 4 пробела <неформатированный текст>
...
1. пример
    ...
    ![<описание>](<расположение изображения>) - вставка изображения

![свидетель](izFruazino.jpg)